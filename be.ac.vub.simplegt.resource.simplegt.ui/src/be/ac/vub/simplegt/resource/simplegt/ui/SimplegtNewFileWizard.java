...
public class SimplegtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtNewFileWizardPage page;
	...
	public void addPages() {
		page = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName();
	}
