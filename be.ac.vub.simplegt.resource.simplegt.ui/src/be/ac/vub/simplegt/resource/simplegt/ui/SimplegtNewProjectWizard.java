				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("be.ac.vub.simplegt.resource.simplegt.ui");
							...
							String natureID = be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtNature.NATURE_ID;
							...
							for (String builderID : be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation info = new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation();
