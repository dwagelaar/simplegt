...
public class SimplegtOccurrence {
	...
	public final static String OCCURRENCE_ANNOTATION_ID = "be.ac.vub.simplegt.resource.simplegt.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "be.ac.vub.simplegt.resource.simplegt.ui.occurences.declaration";
	...
	private be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource textResource;
	 ...
	 */
	public SimplegtOccurrence(be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getTokenNames();
