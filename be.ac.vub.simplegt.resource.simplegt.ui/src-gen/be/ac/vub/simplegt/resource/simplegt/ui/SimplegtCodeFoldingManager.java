...
public class SimplegtCodeFoldingManager {
	...
	private class FoldingUpdateListener implements be.ac.vub.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener {
	...
	protected void calculatePositions() {
		be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource textResource = (be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
