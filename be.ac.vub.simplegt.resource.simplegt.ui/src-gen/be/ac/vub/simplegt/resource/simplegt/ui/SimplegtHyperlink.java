 ...
 */
public class SimplegtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public SimplegtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor) {
					be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor emftEditor = (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor) editorPart;
