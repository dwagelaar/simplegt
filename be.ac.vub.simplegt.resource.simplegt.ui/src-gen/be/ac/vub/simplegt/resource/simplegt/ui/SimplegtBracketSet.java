...
public class SimplegtBracketSet {
	...
	private java.util.ArrayList<be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair {
	...
	private class ClosingListener implements be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public SimplegtBracketSet(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair>();
	 ...
	 */
	public be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair getBracketPair(String opening, String closing) {
		for (be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair : bracketPairs) {
	...
	public be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair, boolean closingEnabledInside) {
	 ...
	 */
	public be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair remove(String opening, String closing) {
		for (be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<be.ac.vub.simplegt.resource.simplegt.ISimplegtBracketPair>();
