...
public class SimplegtAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName())) {
					return new be.ac.vub.simplegt.resource.simplegt.ui.debug.SimplegtLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable) {
			final be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable variable = (be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable) {
			final be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable variable = (be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugValue castedValue = (be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugValue) value;
