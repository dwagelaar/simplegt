 ...
 */
public class SimplegtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<be.ac.vub.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener>();
	...
	public SimplegtEditor() {
		super();
		setSourceViewerConfiguration(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditorConfiguration(this, colorManager));
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource currentResource = getResource();
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("be.ac.vub.simplegt.resource.simplegt.EditorContext");
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtNature.activate(inputFile.getProject());
		...
		be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource loadedResource = (be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource) {
					setResource((be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource) demandLoadedResource);
				} else {
	...
	private void setResource(be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource resource) {
		assert resource != null;
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			be.ac.vub.simplegt.resource.simplegt.ISimplegtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTextToken token = lexer.getNextToken();
	...
	public void addBackgroundParsingListener(be.ac.vub.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (be.ac.vub.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener listener : bgParsingListeners) {
