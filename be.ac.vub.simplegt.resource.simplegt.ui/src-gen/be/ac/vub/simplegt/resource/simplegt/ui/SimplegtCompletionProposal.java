 ...
 */
public class SimplegtCompletionProposal implements java.lang.Comparable<SimplegtCompletionProposal> {
	...
	public SimplegtCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public SimplegtCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public SimplegtCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof SimplegtCompletionProposal) {
			SimplegtCompletionProposal other = (SimplegtCompletionProposal) object;
	...
	public int compareTo(SimplegtCompletionProposal object) {
		if (object instanceof SimplegtCompletionProposal) {
			SimplegtCompletionProposal other = (SimplegtCompletionProposal) object;
