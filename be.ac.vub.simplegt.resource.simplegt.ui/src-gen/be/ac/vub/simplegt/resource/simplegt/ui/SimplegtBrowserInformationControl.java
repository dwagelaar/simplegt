...
public class SimplegtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput);
		...
		fInput= (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) input;
		...
		be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
