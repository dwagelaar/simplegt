...
public class SimplegtQuickAssistProcessor implements org.eclipse.jface.text.quickassist.IQuickAssistProcessor {
	...
	public boolean canFix(org.eclipse.jface.text.source.Annotation annotation) {
		java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ISimplegtQuickFix> quickFixes = getQuickFixes(annotation);
	...
	public org.eclipse.jface.text.contentassist.ICompletionProposal[] computeQuickAssistProposals(org.eclipse.jface.text.quickassist.IQuickAssistInvocationContext invocationContext) {
		...
		java.util.List<be.ac.vub.simplegt.resource.simplegt.ISimplegtQuickFix> quickFixes = getQuickFixes(sourceViewer, offset, length);
	...
	private org.eclipse.jface.text.contentassist.ICompletionProposal createCompletionProposal(final org.eclipse.jface.text.source.ISourceViewer sourceViewer, final be.ac.vub.simplegt.resource.simplegt.ISimplegtQuickFix quickFix) {
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ISimplegtQuickFix> getQuickFixes(org.eclipse.jface.text.source.Annotation annotation) {
