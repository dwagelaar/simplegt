...
public class SimplegtCodeCompletionHelper {
	...
	private void removeDuplicateEntries(java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal> expectedElements) {
	...
	private void removeInvalidEntriesAtEnd(java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal> expectedElements) {
	...
	private String findPrefix(java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal> expectedElements, be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal expectedAtCursor, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return "";
		}
		int end = 0;
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> deriveProposals(java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal> expectedElements, String content, be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource resource, int cursorOffset) {
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> deriveProposals(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal expectedTerminal, String content, be.ac.vub.simplegt.resource.simplegt.ISimplegtTextResource resource, int cursorOffset) {
		be.ac.vub.simplegt.resource.simplegt.ISimplegtMetaInformation metaInformation = resource.getMetaInformation();
		...
		if (expectedElement instanceof be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedCsString) {
			...
			be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedStructuralFeature expectedFeature = (be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedStructuralFeature) expectedElement;
					...
					for (int i = contentList.size() - 1; i >= 0; i--) {
						...
						if (neededClass.isInstance(object)) {
							...
							if (eStructuralFeature.getEType().isInstance(newContainer)) {
								be.ac.vub.simplegt.resource.simplegt.util.SimplegtEObjectUtil.setFeature(object, eStructuralFeature, newContainer, false);
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleEnumAttribute(be.ac.vub.simplegt.resource.simplegt.ISimplegtMetaInformation metaInformation, be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		...
		for (org.eclipse.emf.ecore.EEnumLiteral literal : enumLiterals) {
			...
			result.add(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal(resolvedLiteral, prefix, matchesPrefix, expectedFeature.getFeature(), container));
		}
		return result;
	}
	
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleNCReference(be.ac.vub.simplegt.resource.simplegt.ISimplegtMetaInformation metaInformation, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		if (mappings != null) {
			...
			for (be.ac.vub.simplegt.resource.simplegt.ISimplegtReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtElementMapping<?>) {
					...
					resultSet.add(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal(identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleAttribute(be.ac.vub.simplegt.resource.simplegt.ISimplegtMetaInformation metaInformation, be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EAttribute attribute, String prefix) {
		java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> resultSet = new java.util.LinkedHashSet<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal>();
				...
				if (defaultValue != null) {
					...
					if (tokenName != null) {
						...
						if (tokenResolver != null) {
							...
							resultSet.add(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal(defaultValueAsString, prefix, matchesPrefix, expectedFeature.getFeature(), container));
						}
					}
				}
			}
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleKeyword(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal(proposal, prefix, matchesPrefix, null, null));
	}
	
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleBooleanTerminal(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedBooleanTerminal expectedBooleanTerminal, String prefix) {
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleEnumerationTerminal(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedEnumerationTerminal expectedEnumerationTerminal, String prefix) {
		java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> result = new java.util.LinkedHashSet<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal>(2);
	...
	private java.util.Collection<be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal> handleLiteral(org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		if ("".equals(literal)) {
			return java.util.Collections.emptySet();
		}
		boolean matchesPrefix = matches(literal, prefix);
		return java.util.Collections.singleton(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCompletionProposal(literal, prefix, matchesPrefix, null, null));
	}
	 ...
	 * element is expected.
	 */
	private void setPrefixes(java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal> expectedElements, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return;
		}
		for (be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal expectedElement : expectedElements) {
	...
	private int getEnd(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtExpectedTerminal[] allExpectedElements, int indexInList) {
