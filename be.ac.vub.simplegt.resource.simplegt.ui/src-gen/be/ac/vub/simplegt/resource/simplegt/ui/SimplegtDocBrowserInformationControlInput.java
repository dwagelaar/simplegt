 ...
 * olInput</code>.
 */
public class SimplegtDocBrowserInformationControlInput {
	
	private final SimplegtDocBrowserInformationControlInput fPrevious;
	private SimplegtDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SimplegtDocBrowserInformationControlInput(SimplegtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SimplegtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SimplegtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
