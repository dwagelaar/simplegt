...
public class SimplegtUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "org.eclipselabs.simplegt.resource.simplegt.ui";
	public static final String EDITOR_ID = "org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor";
	...
	private static SimplegtUIPlugin plugin;
	
	public SimplegtUIPlugin() {
		super();
	}
	...
	public static SimplegtUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimplegtUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimplegtUIPlugin.PLUGIN_ID, message);
		}
		final SimplegtUIPlugin pluginInstance = SimplegtUIPlugin.getDefault();
