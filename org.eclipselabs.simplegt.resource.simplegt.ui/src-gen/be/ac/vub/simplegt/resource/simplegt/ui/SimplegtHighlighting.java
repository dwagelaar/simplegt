...
public class SimplegtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	 ...
	 * @param editor
	 */
	public SimplegtHighlighting(org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
		...
		occurrence = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
