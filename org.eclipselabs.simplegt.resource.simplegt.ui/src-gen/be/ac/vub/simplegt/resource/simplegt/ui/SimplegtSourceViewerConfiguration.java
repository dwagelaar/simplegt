...
public class SimplegtSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	public SimplegtSourceViewerConfiguration(org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider resourceProvider, be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtAnnotationModelProvider annotationModelProvider, be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandlerProvider bracketHandlerProvider, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager) {
		super(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.getDefault().getPreferenceStore());
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
