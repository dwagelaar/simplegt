...
public class SimplegtBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
