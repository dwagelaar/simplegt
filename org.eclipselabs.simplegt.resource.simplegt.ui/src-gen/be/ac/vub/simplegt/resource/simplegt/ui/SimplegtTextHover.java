...
public class SimplegtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput infoInput = (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHyperlink hyperlink = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl iControl = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) {
							be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput input = (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl.isAvailable(parent)) {
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl iControl = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	public SimplegtTextHover(org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider resourceProvider) {
		...
		this.hoverTextProvider = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIMetaInformation().getHoverTextProvider();
	}
	 ...
	 */
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.insertPageProlog(buffer, 0, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtTextHover.getStyleSheet());
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addPageEpilog(buffer);
			return new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.PLUGIN_ID);
