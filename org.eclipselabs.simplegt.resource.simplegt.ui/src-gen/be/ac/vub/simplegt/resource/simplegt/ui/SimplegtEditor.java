 ...
 * </p>
 */
public class SimplegtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider, be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandlerProvider, be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtAnnotationModelProvider {
	
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCodeFoldingManager codeFoldingManager;
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBackgroundParsingStrategy bgParsingStrategy = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtBackgroundParsingStrategy();
	...
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtColorManager();
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtOutlinePage outlinePage;
	...
	private be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPropertySheetPage propertySheetPage;
	...
	private be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandler bracketHandler;
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtCodeFoldingManager(viewer, this);
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) {
					...
					be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SimplegtEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandler bracketHandler) {
