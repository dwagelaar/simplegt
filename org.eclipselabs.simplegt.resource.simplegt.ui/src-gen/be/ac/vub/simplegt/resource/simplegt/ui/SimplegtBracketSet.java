...
public class SimplegtBracketSet {
	 ...
	 */
	private class ClosingListener implements be.ac.vub.simplegt.resource.simplegt.ui.ISimplegtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
	 ...
	 */
	public SimplegtBracketSet(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	private void addListeners(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, be.ac.vub.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
