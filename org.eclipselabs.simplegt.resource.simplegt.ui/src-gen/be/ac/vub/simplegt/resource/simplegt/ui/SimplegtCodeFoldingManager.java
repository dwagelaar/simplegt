...
public class SimplegtCodeFoldingManager {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor) {
				be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor = (be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor) workbenchPart;
	...
	protected be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor;
	 ...
	 */
	public SimplegtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor textEditor) {
	...
	private void addCloseListener(final be.ac.vub.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
