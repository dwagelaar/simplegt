 ...
 */
public class SimplegtBracketSet {
	...
	private java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair {
	 ...
	 */
	private class ClosingListener implements org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public SimplegtBracketSet(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair>();
	 ...
	 */
	public org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair getBracketPair(String opening, String closing) {
		for (org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair : bracketPairs) {
	...
	public org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair remove(String opening, String closing) {
		for (org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
