 ...
 */
public class SimplegtSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public SimplegtSourceViewerConfiguration(org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider resourceProvider, org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtAnnotationModelProvider annotationModelProvider, org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandlerProvider bracketHandlerProvider, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager) {
		super(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
