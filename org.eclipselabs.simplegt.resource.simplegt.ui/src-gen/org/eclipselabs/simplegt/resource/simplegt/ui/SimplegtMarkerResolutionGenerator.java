	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.eclipselabs.simplegt.resource.simplegt.ISimplegtOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource) {
					org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource customResource = (org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.eclipselabs.simplegt.resource.simplegt.ISimplegtQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.eclipselabs.simplegt.resource.simplegt.ISimplegtQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.eclipselabs.simplegt.resource.simplegt.ISimplegtQuickFix> getQuickFixes(org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.eclipselabs.simplegt.resource.simplegt.ISimplegtQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
