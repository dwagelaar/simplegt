 ...
 * </ul>
 */
public class SimplegtBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName();
	
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public SimplegtBracketPreferencePage() {
		super();
		
		org.eclipselabs.simplegt.resource.simplegt.ISimplegtMetaInformation metaInformation = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.eclipselabs.simplegt.resource.simplegt.ISimplegtBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) {
			((org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) editor).invalidateTextRepresentation();
		}
	}
