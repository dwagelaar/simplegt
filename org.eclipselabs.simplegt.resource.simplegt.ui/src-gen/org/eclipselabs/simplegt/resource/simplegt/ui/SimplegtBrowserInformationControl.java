 ...
 * @since 3.2
 */
public class SimplegtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput fInput;
	 ...
	 */
	public SimplegtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public SimplegtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public SimplegtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput);
		...
		fInput= (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) input;
		...
		org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
