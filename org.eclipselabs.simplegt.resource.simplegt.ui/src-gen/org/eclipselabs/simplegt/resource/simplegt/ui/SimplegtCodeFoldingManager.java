 ...
 */
public class SimplegtCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) {
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor = (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) workbenchPart;
	...
	protected org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor;
	 ...
	 */
	public SimplegtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor textEditor) {
	...
	private void addCloseListener(final org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource textResource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
