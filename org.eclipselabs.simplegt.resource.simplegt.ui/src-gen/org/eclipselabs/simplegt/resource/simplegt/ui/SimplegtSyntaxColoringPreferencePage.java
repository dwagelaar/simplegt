...
public class SimplegtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public SimplegtSyntaxColoringPreferencePage() {
		...
		org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation metaInformation = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPixelConverter pixelConverter = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) {
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor emfTextEditor = (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor) editor;
