 ...
 */
public class SimplegtBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource, final org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource) {
							org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource concreteResource = (org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource) resource;
