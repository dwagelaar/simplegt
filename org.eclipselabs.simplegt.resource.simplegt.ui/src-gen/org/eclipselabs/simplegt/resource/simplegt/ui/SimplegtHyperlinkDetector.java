 ...
 * hovers, is a proxy.
 */
public class SimplegtHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public SimplegtHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
