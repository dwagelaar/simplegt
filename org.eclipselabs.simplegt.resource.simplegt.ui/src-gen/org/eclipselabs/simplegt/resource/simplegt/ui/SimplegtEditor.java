 ...
 * <p>
 * This editor has id
 * <code>org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor</code>
 * The editor's context menu has id
 * <code>org.eclipselabs.simplegt.resource.simplegt.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.eclipselabs.simplegt.resource.simplegt.EditorRuler</code>.
 * </p>
 */
public class SimplegtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider, org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandlerProvider, org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtAnnotationModelProvider {
	
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtCodeFoldingManager codeFoldingManager;
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBackgroundParsingStrategy bgParsingStrategy = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBackgroundParsingStrategy();
	private java.util.Collection<org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener>();
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtColorManager();
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtOutlinePage outlinePage;
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPropertySheetPage propertySheetPage;
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandler bracketHandler;
	...
	public SimplegtEditor() {
		super();
		setSourceViewerConfiguration(new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), SimplegtEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource currentResource = getResource();
				...
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.eclipselabs.simplegt.resource.simplegt.EditorContext");
		setRulerContextMenuId("org.eclipselabs.simplegt.resource.simplegt.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtNature.activate(inputFile.getProject());
		...
		org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource loadedResource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) {
					setResource((org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SimplegtEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource textResource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) element.eResource();
			org.eclipselabs.simplegt.resource.simplegt.ISimplegtLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextToken token = lexer.getNextToken();
			...
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!SimplegtEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.eclipselabs.simplegt.resource.simplegt.ui.ISimplegtBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource)) {
					return false;
				}
				org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource textResource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) resource;
				org.eclipselabs.simplegt.resource.simplegt.ISimplegtLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
