 ...
 */
public class SimplegtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.eclipselabs.simplegt.resource.simplegt.ISimplegtHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput infoInput = (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHyperlink hyperlink = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl iControl = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) {
							org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput input = (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl.isAvailable(parent)) {
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl iControl = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SimplegtTextHover(org.eclipselabs.simplegt.resource.simplegt.ISimplegtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.insertPageProlog(buffer, 0, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtTextHover.getStyleSheet());
			org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.addPageEpilog(buffer);
			return new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStreamUtil.getContent(styleSheetURL.openStream());
