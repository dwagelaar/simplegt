 ...
 * a specified depth.
 */
public class SimplegtOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public SimplegtOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtPlugin.logError("Exception while refreshing outline view", e);
		}
	}
