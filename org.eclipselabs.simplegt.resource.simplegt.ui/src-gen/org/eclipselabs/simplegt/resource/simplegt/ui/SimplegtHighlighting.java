...
public class SimplegtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionHelper positionHelper = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionHelper();
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtTokenScanner scanner;
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtOccurrence occurrence;
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.eclipselabs.simplegt.resource.simplegt.ISimplegtBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public SimplegtHighlighting(org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtColorManager colorManager, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtTokenScanner(textResource, colorManager);
		occurrence = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
