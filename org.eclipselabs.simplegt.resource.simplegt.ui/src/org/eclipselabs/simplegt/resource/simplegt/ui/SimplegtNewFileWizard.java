...
public class SimplegtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.eclipselabs.simplegt.resource.simplegt.ui.SimplegtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			be.ac.vub.simplegt.resource.simplegt.ui.SimplegtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getSyntaxName();
	}
