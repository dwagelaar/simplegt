...
public class SimplegtNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 * The constructor.
	 */
	public SimplegtNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.eclipselabs.simplegt.resource.simplegt.ui");
							...
							String natureID = org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtNature.NATURE_ID;
							...
							for (String builderID : org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation info = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation();
