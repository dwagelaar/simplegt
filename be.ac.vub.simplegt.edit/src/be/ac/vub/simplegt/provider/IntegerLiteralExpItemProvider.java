...
/**
 * This is the item provider adapter for a {@link be.ac.vub.simplegt.IntegerLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerLiteralExp_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteralExp_literal_feature", "_UI_IntegerLiteralExp_type"),
				 SimplegtPackage.Literals.INTEGER_LITERAL_EXP__LITERAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IntegerLiteralExp_type") + " " + integerLiteralExp.getLine();
	}
