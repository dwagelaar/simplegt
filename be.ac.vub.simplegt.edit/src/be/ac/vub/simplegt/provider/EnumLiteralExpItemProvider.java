...
/**
 * This is the item provider adapter for a {@link be.ac.vub.simplegt.EnumLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumLiteralExp_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumLiteralExp_literal_feature", "_UI_EnumLiteralExp_type"),
				 SimplegtPackage.Literals.ENUM_LITERAL_EXP__LITERAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_EnumLiteralExp_type") + " " + enumLiteralExp.getLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumLiteralExp.class)) {
			case SimplegtPackage.ENUM_LITERAL_EXP__LITERAL:
