...
/**
 * This is the item provider adapter for a {@link be.ac.vub.simplegt.BooleanLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanLiteralExp_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanLiteralExp_literal_feature", "_UI_BooleanLiteralExp_type"),
				 SimplegtPackage.Literals.BOOLEAN_LITERAL_EXP__LITERAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_BooleanLiteralExp_type") + " " + booleanLiteralExp.getLine();
	}
