...
/**
 * This is the item provider adapter for a {@link be.ac.vub.simplegt.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_model_feature", "_UI_Type_type"),
				 SimplegtPackage.Literals.TYPE__MODEL,
				 true,
				 false,
				 false,
				 null,
