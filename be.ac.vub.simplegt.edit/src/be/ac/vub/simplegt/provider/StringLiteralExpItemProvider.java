...
/**
 * This is the item provider adapter for a {@link be.ac.vub.simplegt.StringLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringLiteralExp_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringLiteralExp_literal_feature", "_UI_StringLiteralExp_type"),
				 SimplegtPackage.Literals.STRING_LITERAL_EXP__LITERAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_StringLiteralExp_type") + " " + stringLiteralExp.getLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringLiteralExp.class)) {
			case SimplegtPackage.STRING_LITERAL_EXP__LITERAL:
