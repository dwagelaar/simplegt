 ...
 * <ul>
 *   <li>{@link be.ac.vub.simplegt.impl.LocatedElementImpl#getLine <em>Line</em>}</li>
 *   <li>{@link be.ac.vub.simplegt.impl.LocatedElementImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link be.ac.vub.simplegt.impl.LocatedElementImpl#getCharStart <em>Char Start</em>}</li>
 *   <li>{@link be.ac.vub.simplegt.impl.LocatedElementImpl#getCharEnd <em>Char End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LocatedElementImpl extends EObjectImpl implements LocatedElement {
	...
	protected EClass eStaticClass() {
		return SimplegtPackage.Literals.LOCATED_ELEMENT;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplegtPackage.LOCATED_ELEMENT__LINE:
				return getLine();
			case SimplegtPackage.LOCATED_ELEMENT__COLUMN:
				return getColumn();
			case SimplegtPackage.LOCATED_ELEMENT__CHAR_START:
				return getCharStart();
			case SimplegtPackage.LOCATED_ELEMENT__CHAR_END:
				return getCharEnd();
		}
