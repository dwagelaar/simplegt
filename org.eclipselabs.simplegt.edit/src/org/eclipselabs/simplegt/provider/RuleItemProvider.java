...
import org.eclipselabs.simpleocl.provider.NamedElementItemProvider;

/**
 * This is the item provider adapter for a {@link org.eclipselabs.simplegt.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplegtPackage.Literals.RULE__ABSTRACT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplegtPackage.Literals.RULE__EXTENDS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplegtPackage.Literals.RULE__INPUT);
			childrenFeatures.add(SimplegtPackage.Literals.RULE__NAC);
			childrenFeatures.add(SimplegtPackage.Literals.RULE__OUTPUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplegtPackage.Literals.RULE__INPUT,
				 SimplegtFactory.eINSTANCE.createInPattern()));

		newChildDescriptors.add
			(createChildParameter
				(SimplegtPackage.Literals.RULE__NAC,
				 SimplegtFactory.eINSTANCE.createNacPattern()));

		newChildDescriptors.add
			(createChildParameter
				(SimplegtPackage.Literals.RULE__OUTPUT,
				 SimplegtFactory.eINSTANCE.createOutPattern()));
	}
