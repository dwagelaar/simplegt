...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simplegt.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider
	extends org.eclipselabs.simpleocl.provider.ModuleItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_debug_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_debug_feature", "_UI_Module_type"),
				 SimplegtPackage.Literals.MODULE__DEBUG,
				 true,
				 false,
				 false,
