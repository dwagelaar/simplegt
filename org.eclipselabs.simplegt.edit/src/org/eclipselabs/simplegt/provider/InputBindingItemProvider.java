...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simplegt.InputBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputBindingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputBinding_last_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputBinding_last_feature", "_UI_InputBinding_type"),
				 SimplegtPackage.Literals.INPUT_BINDING__LAST,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		InputBinding inputBinding = (InputBinding)object;
		return getString("_UI_InputBinding_type") + " " + inputBinding.getLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InputBinding.class)) {
