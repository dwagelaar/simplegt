...
public class SimplegtDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private be.ac.vub.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, be.ac.vub.simplegt.resource.simplegt.util.SimplegtPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, be.ac.vub.simplegt.resource.simplegt.util.SimplegtPair<String, Object>>();
	...
	private void runDebugger() throws java.io.IOException {
		...
		be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = be.ac.vub.simplegt.resource.simplegt.util.SimplegtStringUtil.encode('#', stack);
				be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_VARIABLES)) {
				...
				be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugMessage(be.ac.vub.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return be.ac.vub.simplegt.resource.simplegt.util.SimplegtStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		be.ac.vub.simplegt.resource.simplegt.util.SimplegtPair<String, Object> pair = new be.ac.vub.simplegt.resource.simplegt.util.SimplegtPair<String, Object>(name, value);
	...
	public be.ac.vub.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(be.ac.vub.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable debuggable) {
