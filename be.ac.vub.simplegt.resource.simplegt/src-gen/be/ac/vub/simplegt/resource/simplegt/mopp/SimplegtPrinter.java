...
public class SimplegtPrinter implements be.ac.vub.simplegt.resource.simplegt.ISimplegtTextPrinter {
	...
	public void print_be_ac_vub_simplegt_Module(be.ac.vub.simplegt.Module element, String outertab, java.io.PrintWriter out) {
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__METAMODELS));
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__ELEMENTS));
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__DEBUG));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__DEBUG));
			if (o != null) {
			}
		...
		while (iterate) {
			...
			out1 = new java.io.PrintWriter(sWriter);
			printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
			print_be_ac_vub_simplegt_Module_2(element, localtab, out1, printCountingMap1);
			if (printCountingMap.equals(printCountingMap1)) {
				iterate = false;
				out1.close();
			} else {
		...
		while (iterate) {
			...
			out1 = new java.io.PrintWriter(sWriter);
			printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
			print_be_ac_vub_simplegt_Module_3(element, localtab, out1, printCountingMap1);
			if (printCountingMap.equals(printCountingMap1)) {
				iterate = false;
				out1.close();
			} else {
	...
	public void print_be_ac_vub_simplegt_Module_0(be.ac.vub.simplegt.Module element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			java.util.List<?> list = (java.util.List<?>)element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__IMPORTS));
			int index  = list.size() - count;
			if (index < 0) {
				index = 0;
			}
	...
	public void print_be_ac_vub_simplegt_Module_1(be.ac.vub.simplegt.Module element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			java.util.List<?> list = (java.util.List<?>)element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__METAMODELS));
			int index  = list.size() - count;
			if (index < 0) {
				index = 0;
			}
	...
	public void print_be_ac_vub_simplegt_Module_2(be.ac.vub.simplegt.Module element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		String localtab = outertab;
		int count;
		// DEFINITION PART BEGINS (CsString)
		out.print(",");
	...
	public void print_be_ac_vub_simplegt_Module_3(be.ac.vub.simplegt.Module element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		String localtab = outertab;
		int count;
		// DEFINITION PART BEGINS (Containment)
		count = printCountingMap.get("elements");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.MODULE__ELEMENTS));
			java.util.List<?> list = (java.util.List<?>) o;
			int index = list.size() - count;
			if (index >= 0) {
				o = list.get(index);
	...
	public void print_be_ac_vub_simplegt_InputElement(be.ac.vub.simplegt.InputElement element, String outertab, java.io.PrintWriter out) {
		...
		java.util.Map<String, Integer> printCountingMap = new java.util.LinkedHashMap<String, Integer>(10);
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_ELEMENT__VAR_NAME));
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_ELEMENT__VARIABLE_EXP));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_ELEMENT__VAR_NAME));
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_ELEMENT__VAR_NAME), element));
				out.print(" ");
			}
	...
	public void print_be_ac_vub_simplegt_InputBinding(be.ac.vub.simplegt.InputBinding element, String outertab, java.io.PrintWriter out) {
		...
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_BINDING__LAST));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.INPUT_BINDING__LAST));
			if (o != null) {
			}
	...
	public void print_be_ac_vub_simplegt_OutputElement(be.ac.vub.simplegt.OutputElement element, String outertab, java.io.PrintWriter out) {
		...
		java.util.Map<String, Integer> printCountingMap = new java.util.LinkedHashMap<String, Integer>(10);
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_ELEMENT__VAR_NAME));
		printCountingMap.put("varName", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_ELEMENT__TYPE));
		printCountingMap.put("type", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_ELEMENT__VARIABLE_EXP));
		printCountingMap.put("variableExp", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		...
		count = printCountingMap.get("varName");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_ELEMENT__VAR_NAME));
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_ELEMENT__VAR_NAME), element));
				out.print(" ");
			}
			printCountingMap.put("varName", count - 1);
		}
	...
	public void print_be_ac_vub_simplegt_OutputBinding(be.ac.vub.simplegt.OutputBinding element, String outertab, java.io.PrintWriter out) {
		...
		printCountingMap.put("element", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__BEFORE_ELEMENT));
		...
		count = printCountingMap.get("property");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__PROPERTY));
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__PROPERTY), element));
				out.print(" ");
			}
			printCountingMap.put("property", count - 1);
		}
		...
		count = printCountingMap.get("expr");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__EXPR));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
			printCountingMap.put("expr", count - 1);
	...
	public void print_be_ac_vub_simplegt_OutputBinding_0(be.ac.vub.simplegt.OutputBinding element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__BEFORE_ELEMENT));
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getOutputBindingBeforeElementReferenceResolver().deResolve((be.ac.vub.simplegt.RuleElement) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__BEFORE_ELEMENT)), element.eClass().getEStructuralFeature(be.ac.vub.simplegt.SimplegtPackage.OUTPUT_BINDING__BEFORE_ELEMENT), element));
				out.print(" ");
			}
	...
	public void print_be_ac_vub_simpleocl_LocalVariable(be.ac.vub.simpleocl.LocalVariable element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("EQ");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OperatorCallExp(be.ac.vub.simpleocl.OperatorCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLOP");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("NEQ");
						resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_RelOpCallExp(be.ac.vub.simpleocl.RelOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("RELOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_AddOpCallExp(be.ac.vub.simpleocl.AddOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("ADDOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_IntOpCallExp(be.ac.vub.simpleocl.IntOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_MulOpCallExp(be.ac.vub.simpleocl.MulOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("MULOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_NotOpCallExp(be.ac.vub.simpleocl.NotOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("NOTOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_CollectionType(be.ac.vub.simpleocl.CollectionType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("COLLECTIONTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_StringType(be.ac.vub.simpleocl.StringType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRINGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_BooleanType(be.ac.vub.simpleocl.BooleanType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLEANTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_IntegerType(be.ac.vub.simpleocl.IntegerType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTEGERTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_RealType(be.ac.vub.simpleocl.RealType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("REALTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_BagType(be.ac.vub.simpleocl.BagType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("BAGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OrderedSetType(be.ac.vub.simpleocl.OrderedSetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("ORDEREDSETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_SequenceType(be.ac.vub.simpleocl.SequenceType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("SEQUENCETYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_SetType(be.ac.vub.simpleocl.SetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("SETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OclAnyType(be.ac.vub.simpleocl.OclAnyType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLANYTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OclType(be.ac.vub.simpleocl.OclType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLTYPE");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLE");
						resolver.setOptions(getOptions());
			...
			if (count > 0) {
				Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME));
				if (o != null) {
					be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLETYPE");
					resolver.setOptions(getOptions());
					out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(be.ac.vub.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME), element));
					out.print(" ");
				}
	...
	public void print_be_ac_vub_simpleocl_MapType(be.ac.vub.simpleocl.MapType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("MAPTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_LambdaType(be.ac.vub.simpleocl.LambdaType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("LAMBDATYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_EnvType(be.ac.vub.simpleocl.EnvType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver resolver = tokenResolverFactory.createTokenResolver("ENVTYPE");
				resolver.setOptions(getOptions());
