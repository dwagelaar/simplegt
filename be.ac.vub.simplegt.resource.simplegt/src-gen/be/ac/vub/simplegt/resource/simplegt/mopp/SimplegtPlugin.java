 ...
 */
public class SimplegtPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "be.ac.vub.simplegt.resource.simplegt";
	/**
	...
	private static SimplegtPlugin plugin;
	
	public SimplegtPlugin() {
		super();
	}
	...
	public static SimplegtPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimplegtPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimplegtPlugin.PLUGIN_ID, message);
		}
		final SimplegtPlugin pluginInstance = SimplegtPlugin.getDefault();
