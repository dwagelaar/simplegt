...
public class AbstractSimplegtInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete_be_ac_vub_simplegt_Module(be.ac.vub.simplegt.Module module, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_Rule(be.ac.vub.simplegt.Rule rule, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_InputElementPattern(be.ac.vub.simplegt.InputElementPattern inputElementPattern, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_InPattern(be.ac.vub.simplegt.InPattern inPattern, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_NacPattern(be.ac.vub.simplegt.NacPattern nacPattern, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_OutPattern(be.ac.vub.simplegt.OutPattern outPattern, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_RuleElement(be.ac.vub.simplegt.RuleElement ruleElement, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_InputElement(be.ac.vub.simplegt.InputElement inputElement, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_OutputElement(be.ac.vub.simplegt.OutputElement outputElement, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_Binding(be.ac.vub.simplegt.Binding binding, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_InputBinding(be.ac.vub.simplegt.InputBinding inputBinding, ContextType context) {
		return null;
	}
	
	public ResultType interprete_be_ac_vub_simplegt_OutputBinding(be.ac.vub.simplegt.OutputBinding outputBinding, ContextType context) {
		return null;
	}
