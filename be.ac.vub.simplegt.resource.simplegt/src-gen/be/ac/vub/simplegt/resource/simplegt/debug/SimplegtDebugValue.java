...
public class SimplegtDebugValue extends be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public SimplegtDebugValue(be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
