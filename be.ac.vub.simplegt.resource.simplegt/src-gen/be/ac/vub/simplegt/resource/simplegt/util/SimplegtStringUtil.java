...
public class SimplegtStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, be.ac.vub.simplegt.resource.simplegt.ISimplegtFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, be.ac.vub.simplegt.resource.simplegt.ISimplegtFunction1<String, T> toStringFunction) {
