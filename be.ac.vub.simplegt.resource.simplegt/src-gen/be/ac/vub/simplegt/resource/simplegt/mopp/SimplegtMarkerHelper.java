...
public class SimplegtMarkerHelper {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final be.ac.vub.simplegt.resource.simplegt.ISimplegtTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final be.ac.vub.simplegt.resource.simplegt.ISimplegtTextDiagnostic diagnostic) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, be.ac.vub.simplegt.resource.simplegt.SimplegtEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	 ...
	 * given type.
	 */
	private static String getMarkerID(be.ac.vub.simplegt.resource.simplegt.SimplegtEProblemType problemType) {
