...
public class SimplegtLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		layoutInformationAdapter.getLayoutInformations();
		for (java.util.Iterator<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtSyntaxElement syntaxElement = be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtPlaceholder) {
			be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtPlaceholder placeholder = (be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtPlaceholder) syntaxElement;
			be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver tokenResolver = new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolveResult result = new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
