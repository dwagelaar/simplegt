 ...
 */
public class SimplegtDefaultTokenResolver implements be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, be.ac.vub.simplegt.resource.simplegt.ISimplegtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtGrammarInformationProvider.INSTANCE.getKeywords()) {
