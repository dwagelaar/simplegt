 ...
 * given name.
 */
public class SimplegtReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements be.ac.vub.simplegt.resource.simplegt.ISimplegtReferenceCache {
	...
	private be.ac.vub.simplegt.resource.simplegt.ISimplegtNameProvider nameProvider;
	
	public SimplegtReferenceCache(be.ac.vub.simplegt.resource.simplegt.ISimplegtNameProvider nameProvider) {
		super();
