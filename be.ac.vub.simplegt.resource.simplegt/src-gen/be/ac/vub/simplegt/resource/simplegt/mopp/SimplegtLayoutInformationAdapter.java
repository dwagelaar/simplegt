...
public class SimplegtLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation> layoutInformations = new java.util.ArrayList<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation>();
	...
	public java.util.List<be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtLayoutInformation layoutInformation) {
