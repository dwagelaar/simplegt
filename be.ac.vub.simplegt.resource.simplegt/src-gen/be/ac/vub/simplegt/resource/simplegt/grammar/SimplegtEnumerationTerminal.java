 ...
 */
public class SimplegtEnumerationTerminal extends be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public SimplegtEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtCardinality cardinality, int mandatoryOccurrencesAfter) {
