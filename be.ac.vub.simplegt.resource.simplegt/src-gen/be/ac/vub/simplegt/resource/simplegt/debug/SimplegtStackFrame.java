...
public class SimplegtStackFrame extends be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget target;
	private String name;
	private int id;
	...
	public SimplegtStackFrame(be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = be.ac.vub.simplegt.resource.simplegt.util.SimplegtStringUtil.decode(data, ',');
	...
	private be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		be.ac.vub.simplegt.resource.simplegt.debug.SimplegtStackFrame other = (be.ac.vub.simplegt.resource.simplegt.debug.SimplegtStackFrame) obj;
		if (name == null) {
