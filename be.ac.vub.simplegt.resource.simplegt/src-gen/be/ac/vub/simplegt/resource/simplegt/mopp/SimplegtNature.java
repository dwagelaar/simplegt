...
public class SimplegtNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "be.ac.vub.simplegt.resource.simplegt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
