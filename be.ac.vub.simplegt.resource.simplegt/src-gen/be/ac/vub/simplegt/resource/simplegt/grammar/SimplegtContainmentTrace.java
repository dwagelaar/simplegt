...
public class SimplegtContainmentTrace {
	 ...
	 */
	private be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtContainedFeature[] path;
	
	public SimplegtContainmentTrace(org.eclipse.emf.ecore.EClass startClass, be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtContainedFeature[] path) {
		super();
		// Verify arguments
		if (startClass != null) {
			if (path.length > 0) {
	...
	public be.ac.vub.simplegt.resource.simplegt.mopp.SimplegtContainedFeature[] getPath() {
		return path;
	}
	
	public String toString() {
		return (startClass == null ? "null" : startClass.getName()) + "->" + be.ac.vub.simplegt.resource.simplegt.util.SimplegtStringUtil.explode(path, "->");
	}
