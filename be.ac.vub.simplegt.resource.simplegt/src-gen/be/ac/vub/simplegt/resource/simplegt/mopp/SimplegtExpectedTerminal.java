...
public class SimplegtExpectedTerminal {
	...
	private be.ac.vub.simplegt.resource.simplegt.ISimplegtExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtContainmentTrace containmentTrace;
	
	public SimplegtExpectedTerminal(org.eclipse.emf.ecore.EObject container, be.ac.vub.simplegt.resource.simplegt.ISimplegtExpectedElement terminal, int followSetID, be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtContainmentTrace containmentTrace) {
		super();
	...
	public be.ac.vub.simplegt.resource.simplegt.ISimplegtExpectedElement getTerminal() {
		return terminal;
	}
	...
	public be.ac.vub.simplegt.resource.simplegt.grammar.SimplegtContainmentTrace getContainmentTrace() {
