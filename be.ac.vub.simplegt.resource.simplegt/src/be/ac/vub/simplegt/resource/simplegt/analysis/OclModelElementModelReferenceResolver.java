...
public class OclModelElementModelReferenceResolver implements be.ac.vub.simplegt.resource.simplegt.ISimplegtReferenceResolver<be.ac.vub.simpleocl.OclModelElement, be.ac.vub.simpleocl.OclModel> {
	
	private be.ac.vub.simpleocl.resource.simpleocl.analysis.OclModelElementModelReferenceResolver delegate = new be.ac.vub.simpleocl.resource.simpleocl.analysis.OclModelElementModelReferenceResolver();
	
	public void resolve(String identifier, be.ac.vub.simpleocl.OclModelElement container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final be.ac.vub.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<be.ac.vub.simpleocl.OclModel> result) {
