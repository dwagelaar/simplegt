...
public class SimplegtLineBreakpoint extends AtlBreakpoint {
	...
	public void install(be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget target) {
		try {
	...
	public void remove(be.ac.vub.simplegt.resource.simplegt.debug.SimplegtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
