 ...
 */
public class SimplegtResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.eclipselabs.simplegt.resource.simplegt.util.SimplegtInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.eclipselabs.simplegt.resource.simplegt.util.SimplegtInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource getResource(java.io.File file) {
	...
	public static org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource) resource;
	}
	 ...
	 */
	public static org.eclipselabs.simplegt.Module getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.eclipselabs.simplegt.Module getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.eclipselabs.simplegt.Module) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.eclipselabs.simplegt.Module getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
