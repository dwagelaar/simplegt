...
public class SimplegtStackFrame extends org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugTarget target;
	private String name;
	private int id;
	...
	public SimplegtStackFrame(org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.decode(data, ',');
	...
	private org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtStackFrame other = (org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtStackFrame) obj;
		if (name == null) {
