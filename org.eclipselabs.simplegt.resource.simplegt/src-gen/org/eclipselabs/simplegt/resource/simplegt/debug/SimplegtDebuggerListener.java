 ...
 * code).
 */
public class SimplegtDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.eclipselabs.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.eclipselabs.simplegt.resource.simplegt.util.SimplegtPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.eclipselabs.simplegt.resource.simplegt.util.SimplegtPair<String, Object>>();
	...
	public SimplegtDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.encode('#', stack);
				org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_VARIABLES)) {
				...
				org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage message = new org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugMessage(org.eclipselabs.simplegt.resource.simplegt.debug.ESimplegtDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.eclipselabs.simplegt.resource.simplegt.util.SimplegtPair<String, Object> pair = new org.eclipselabs.simplegt.resource.simplegt.util.SimplegtPair<String, Object>(name, value);
	...
	public org.eclipselabs.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.eclipselabs.simplegt.resource.simplegt.debug.AbstractSimplegtDebuggable debuggable) {
