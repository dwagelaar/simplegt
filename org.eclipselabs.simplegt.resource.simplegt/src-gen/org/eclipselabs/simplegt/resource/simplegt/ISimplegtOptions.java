 ...
 */
public interface ISimplegtOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation().getResourcePostProcessorProviderOptionKey();
