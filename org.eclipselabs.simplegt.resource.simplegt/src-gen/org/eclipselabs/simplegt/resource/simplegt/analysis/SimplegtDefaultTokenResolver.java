 ...
 */
public class SimplegtDefaultTokenResolver implements org.eclipselabs.simplegt.resource.simplegt.ISimplegtTokenResolver {
	 ...
	 */
	public SimplegtDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public SimplegtDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.eclipselabs.simplegt.resource.simplegt.ISimplegtTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.eclipselabs.simplegt.resource.simplegt.ISimplegtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.eclipselabs.simplegt.resource.simplegt.grammar.SimplegtGrammarInformationProvider.INSTANCE.getKeywords()) {
