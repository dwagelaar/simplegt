...
public class SimplegtDefaultResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	...
	private static org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation metaInformation = new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtMetaInformation();
	
	private org.eclipselabs.simplegt.resource.simplegt.ISimplegtNameProvider nameProvider = metaInformation.createNameProvider();
	 ...
	 */
	protected void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result) {
		try {
	 ...
	 */
	protected boolean tryToResolveIdentifierInObjectTree(String identifier, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EObject root, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result, boolean checkRootFirst) {
	...
	protected boolean tryToResolveIdentifierAsURI(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean tryToResolveIdentifierInGenModelRegistry(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean checkElement(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EReference reference, int position, org.eclipse.emf.ecore.EClass type, String identifier, boolean resolveFuzzy, boolean checkStringWise, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result) {
		...
		if (exactMatch == null) {
			...
			if (similarMatch != null) {
				...
				result.addQuickFix(new org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtChangeReferenceQuickFix("Replace with " + similarMatch, "IMG_TOOL_FORWARD", container, reference, oldTarget, element));
			}
			return true;
		}
	...
	protected String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextResource resource) {
	...
	protected org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceCache getCache(org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EObject root = org.eclipse.emf.ecore.util.EcoreUtil.getRootContainer(object);
		org.eclipse.emf.common.notify.Adapter adapter = org.eclipselabs.simplegt.resource.simplegt.util.SimplegtEObjectUtil.getEAdapter(root, org.eclipselabs.simplegt.resource.simplegt.analysis.SimplegtReferenceCache.class);
		org.eclipselabs.simplegt.resource.simplegt.analysis.SimplegtReferenceCache cache = org.eclipselabs.simplegt.resource.simplegt.util.SimplegtCastUtil.cast(adapter);
		if (cache != null) {
			return cache;
		} else {
			// cache does not exist. create a new one.
			cache = new org.eclipselabs.simplegt.resource.simplegt.analysis.SimplegtReferenceCache(nameProvider);
	...
	protected boolean isSimilar(String identifier, Object attributeValue) {
		if (attributeValue != null && attributeValue instanceof String) {
			String name = (String) attributeValue;
			if (org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.computeLevenshteinDistance(identifier, name) <= MAX_DISTANCE) {
				return true;
			}
		}
		return false;
