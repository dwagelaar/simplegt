 ...
 * resolver
 */
public interface ISimplegtReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.eclipselabs.simplegt.resource.simplegt.ISimplegtConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<ReferenceType> result);
