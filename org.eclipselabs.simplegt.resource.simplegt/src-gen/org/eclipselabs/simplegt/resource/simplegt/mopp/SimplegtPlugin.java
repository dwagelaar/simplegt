...
public class SimplegtPlugin extends org.eclipse.core.runtime.Plugin {
	...
	public static final String PLUGIN_ID = "org.eclipselabs.simplegt.resource.simplegt";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, SimplegtPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, SimplegtPlugin.PLUGIN_ID, message);
		}
