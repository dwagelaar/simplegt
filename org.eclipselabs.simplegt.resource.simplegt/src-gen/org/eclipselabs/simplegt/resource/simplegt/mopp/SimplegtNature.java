...
public class SimplegtNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.eclipselabs.simplegt.resource.simplegt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
