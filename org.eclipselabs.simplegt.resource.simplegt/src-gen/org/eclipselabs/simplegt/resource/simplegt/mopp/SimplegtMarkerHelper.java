 ...
 * contains
 * <code>org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextDiagnostic</code>s
...
public class SimplegtMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>> commands = new java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>> commandsToProcess = new java.util.ArrayList<org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextDiagnostic diagnostic) {
		final org.eclipselabs.simplegt.resource.simplegt.ISimplegtProblem problem = diagnostic.getProblem();
		org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemSeverity.ERROR) {
					...
					org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextDiagnostic textDiagnostic = (org.eclipselabs.simplegt.resource.simplegt.ISimplegtTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.eclipselabs.simplegt.resource.simplegt.ISimplegtQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.eclipselabs.simplegt.resource.simplegt.util.SimplegtStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType nextType : org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.eclipselabs.simplegt.resource.simplegt.SimplegtEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.eclipselabs.simplegt.resource.simplegt.util.SimplegtRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.eclipselabs.simplegt.resource.simplegt.ISimplegtCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.eclipselabs.simplegt.resource.simplegt.mopp.SimplegtPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
