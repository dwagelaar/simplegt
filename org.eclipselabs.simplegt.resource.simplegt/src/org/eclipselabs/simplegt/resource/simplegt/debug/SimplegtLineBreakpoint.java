 ...
 */
public class SimplegtLineBreakpoint extends AtlBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.eclipse.m2m.atl.debug.core.atlBreakpointMarker";
	
	public SimplegtLineBreakpoint() {
		super();
	}
	
	public SimplegtLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugTarget target) {
		try {
	...
	public void remove(org.eclipselabs.simplegt.resource.simplegt.debug.SimplegtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
