...
public class OclModelElementExpModelReferenceResolver implements org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolver<org.eclipselabs.simpleocl.OclModelElementExp, org.eclipselabs.simpleocl.OclModel> {
	
	private org.eclipselabs.simpleocl.resource.simpleocl.analysis.OclModelElementExpModelReferenceResolver delegate = new org.eclipselabs.simpleocl.resource.simpleocl.analysis.OclModelElementExpModelReferenceResolver();
	
	public void resolve(String identifier, org.eclipselabs.simpleocl.OclModelElementExp container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.eclipselabs.simplegt.resource.simplegt.ISimplegtReferenceResolveResult<org.eclipselabs.simpleocl.OclModel> result) {
